...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Project[] projects = {
                ...
                new Project("PPR", "Allows multiple users to showcase and promote their academies, providing a platform for players to make bookings.", R.drawable.pnplogo),
                new Project("BUDDY", "Sports activity app enabling users to seamlessly monitor and enhance their fitness journey.", R.drawable.buddylogo),
